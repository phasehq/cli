...
from phase_cli.utils.network import revoke_dynamic_secret_lease


def phase_dynamic_secrets_lease_revoke(lease_id, env_name=None, phase_app=None, phase_app_id=None):
    """
    Revoke a dynamic secret lease by lease_id.
    """
    console = Console()
    try:
        phase = Phase()
        ...
        response = revoke_dynamic_secret_lease(
            phase._token_type,
